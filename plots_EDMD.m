function plots_EDMD(n, Ts, mode, umax, comparison, data_EDMD, M_LINEAR, M_EDMD, M_BILINEAR)
    ...
    figure;
    x = ["EDMD" "BILINEAR"];
    y = [comparison.errors.EDMD_fro_training_lifted comparison.errors.BILINEAR_fro_training_lifted];
    bar(x,y);
    ...
    figure;
    x = ["LINEAR" "EDMD" "BILINEAR"];
    y = [comparison.errors.LINEAR_fro_testing comparison.errors.EDMD_fro_testing comparison.errors.BILINEAR_fro_testing];
    bar(x,y);
    ...
    figure;
    x = ["EDMD" "BILINEAR"];
    y = [comparison.errors.EDMD_fro_lifted_testing comparison.errors.BILINEAR_fro_lifted_testing];
    bar(x,y);
