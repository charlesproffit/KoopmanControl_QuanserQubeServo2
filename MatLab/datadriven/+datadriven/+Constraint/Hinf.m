function [constraints, slack] = Hinf(plant, controller, omegas, opts)
%HINF Sets up a $H_\infty$ constraint for a LFR plant
%   
%   This function sets up the $H_\infty$ constraint for the generalised plant
...
% 
%   [constraints, slack] = Hinf(plant, controller, omegas)
% 
%   [constraints, slack] = Hinf(..., "strict", false) solves the slacked version 
%   of the constraint.
% 
%   [constraints, slack] = Hinf(..., "epsNormalisation", eps) sets the eps for
%   normalisation of the constraint. Negative eps disables the normalisation.
% 
%   [constraints, slack] = Hinf(..., "epsSVD", eps) sets the eps for 
...
[constraints, objective] = datadriven.Objective.Hinf(plant, controller, omegas, ...
